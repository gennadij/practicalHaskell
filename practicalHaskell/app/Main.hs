...
main = do
  ...
  print $ "clientToPurchaseInfo: " ++ show (clientToPurchaseInfo (Company "1984 Inc." (Person "George" "Orwell" Male) "Director"))
  print $ "findFactors : " ++ show (findTwoFactors 564 34567)
  print $ "brocken Jumps " ++ show (brockenThreeJumps 2100)
  print "END"
